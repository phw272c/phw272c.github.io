...
See <a href="https://raw.githubusercontent.com/phw272c/phw272c.github.io/master/code/table_joins.R" target="_blank">here</a> for a worked example of table joins in R.
...
ETH_land_use <- raster("https://github.com/phw272c/phw272c.github.io/blob/master/data/ETH_land_use.tif?raw=true")
ETH_land_use
...
see <a href="https://raw.githubusercontent.com/phw272c/phw272c.github.io/master/code/raster_resampling.R" target="_blank">here</a>. The default method is bilinear interpolation,
...
## Useful resources
* The [raster package vignette](https://cran.r-project.org/web/packages/raster/vignettes/Raster.pdf) is extremely useful

* If you are bumping into speed issues extracting/summarizing raster data, have a look at the [velox package](http://philipphunziker.com/velox/)
...
## Pop quiz answers
Can be found [here](https://raw.githubusercontent.com/HughSt/HughSt.github.io/master/course_materials/week2/cheat_sheet_week2_2019.R)
