...
summary(nyc_car_mod)
```
How has the inclusion of a spatial term affected our estimates? Remember from week 6, that if you want to generate 95% CIs of your estimates you can use the following code
