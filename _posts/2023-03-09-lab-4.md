...
```
    ...
    ## Warning in raster::getData(name = "GADM", country = "ETH", level = 1): getData will be removed in a future version of raster
...
```
    ...
    ## Warning in raster::getData(name = "alt", country = "ETH"): getData will be removed in a future version of raster
    ## . Please use the geodata package instead
...
```
    ...
    ## Warning in raster::getData(name = "GADM", country = "SSD", level = 0): getData will be removed in a future version of raster
    ## . Please use the geodata package instead
...
```
    ...
    ## Warning in raster::getData(name = "alt", country = "ETH", mask = FALSE): getData will be removed in a future version of raster
    ## . Please use the geodata package instead
...
```
    ...
    ## Warning in raster::getData(name = "worldclim", var = "prec", res = 10): getData will be removed in a future version of raster
    ## . Please use the geodata package instead
...
```
    ...
    ## Warning in raster::getData(name = "worldclim", var = "prec", res = 0.5, : getData will be removed in a future version of raster
    ## . Please use the geodata package instead
...
```
    ...
    ## extent     : 30, 60, -3.332445e-12, 30  (xmin, xmax, ymin, ymax)
    ## crs        : +proj=longlat +datum=WGS84 +no_defs 
